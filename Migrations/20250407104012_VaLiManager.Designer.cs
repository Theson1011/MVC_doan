...
namespace ThuchanhMVC.Migrations
{
    ...
    [Migration("20250407104012_VaLiManager")]
    partial class VaLiManager
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TAnhSp", b =>
                {
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TChatLieu", b =>
                {
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TChiTietHdb", b =>
                {
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TChiTietSanPham", b =>
                {
                    b.Property<string>("MaChiTietSp")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TDanhMucSp", b =>
                {
                    b.Property<string>("MaSp")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.THangSx", b =>
                {
                    b.Property<string>("MaHangSx")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.THoaDonBan", b =>
                {
                    b.Property<string>("MaHoaDon")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TKhachHang", b =>
                {
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TKichThuoc", b =>
                {
                    b.Property<string>("MaKichThuoc")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TLoaiDt", b =>
                {
                    b.Property<string>("MaDt")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TLoaiSp", b =>
                {
                    b.Property<string>("MaLoai")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TMauSac", b =>
                {
                    b.Property<string>("MaMauSac")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TNhanVien", b =>
                {
                    b.Property<string>("MaNhanVien")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TQuocGium", b =>
                {
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TUser", b =>
                {
                    b.Property<string>("Username")
                        .HasMaxLength(100)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TAnhChiTietSp", b =>
                {
                    b.HasOne("ThuchanhMVC.Models.TChiTietSanPham", "MaChiTietSpNavigation")
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TAnhSp", b =>
                {
                    b.HasOne("ThuchanhMVC.Models.TDanhMucSp", "MaSpNavigation")
                        .WithMany("TAnhSps")
                        .HasForeignKey("MaSp")
                        .IsRequired()
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TChiTietHdb", b =>
                {
                    ...
                    b.HasOne("ThuchanhMVC.Models.THoaDonBan", "MaHoaDonNavigation")
                        .WithMany("TChiTietHdbs")
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TChiTietSanPham", b =>
                {
                    b.HasOne("ThuchanhMVC.Models.TKichThuoc", "MaKichThuocNavigation")
                        .WithMany("TChiTietSanPhams")
                        .HasForeignKey("MaKichThuoc")
                        .HasConstraintName("FK_tChiTietSanPham_tKichThuoc");

                    b.HasOne("ThuchanhMVC.Models.TMauSac", "MaMauSacNavigation")
                        .WithMany("TChiTietSanPhams")
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TDanhMucSp", b =>
                {
                    b.HasOne("ThuchanhMVC.Models.TChatLieu", "MaChatLieuNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaChatLieu")
                        .HasConstraintName("FK_tDanhMucSP_tChatLieu");

                    b.HasOne("ThuchanhMVC.Models.TLoaiDt", "MaDtNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaDt")
                        .HasConstraintName("FK_tDanhMucSP_tLoaiDT");

                    b.HasOne("ThuchanhMVC.Models.THangSx", "MaHangSxNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaHangSx")
                        .HasConstraintName("FK_tDanhMucSP_tHangSX");

                    b.HasOne("ThuchanhMVC.Models.TLoaiSp", "MaLoaiNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaLoai")
                        .HasConstraintName("FK_tDanhMucSP_tLoaiSP");

                    b.HasOne("ThuchanhMVC.Models.TQuocGium", "MaNuocSxNavigation")
                        .WithMany("TDanhMucSps")
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.THoaDonBan", b =>
                {
                    b.HasOne("ThuchanhMVC.Models.TKhachHang", "MaKhachHangNavigation")
                        .WithMany("THoaDonBans")
                        .HasForeignKey("MaKhachHang")
                        .HasConstraintName("FK_tHoaDonBan_tKhachHang");

                    b.HasOne("ThuchanhMVC.Models.TNhanVien", "MaNhanVienNavigation")
                        .WithMany("THoaDonBans")
            ...
            modelBuilder.Entity("ThuchanhMVC.Models.TKhachHang", b =>
                {
                    b.HasOne("ThuchanhMVC.Models.TUser", "UsernameNavigation")
